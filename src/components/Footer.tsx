...
export function Footer() {
  ...
  const insta = siteConfig.instagram.replace('@', '');
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          <div className="col-span-2 flex flex-col items-center text-center md:col-span-1 md:items-start md:text-left">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/50">{siteConfig.tagline}</p>
            <div className="mt-4 flex gap-3">
              <a href={siteConfig.instagramUrl} target="_blank" rel="noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-white/20" aria-label="Instagram">
                <Instagram size={17} />
              </a>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-white/50">
              <li className="flex items-start gap-2"><MapPin size={15} className="mt-0.5 shrink-0 text-white/30" /> {siteConfig.address}</li>
              <li className="flex items-start gap-2"><Clock size={15} className="mt-0.5 shrink-0 text-white/30" /> {siteConfig.hoursStore}</li>
              <li className="flex items-start gap-2"><Globe size={15} className="mt-0.5 shrink-0 text-white/30" /> {siteConfig.hoursSite}</li>
            </ul>
          </div>
        </div>
