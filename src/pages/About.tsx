    ...
    <div>
      ...
      <section className="mx-auto max-w-3xl px-4 py-12 md:px-6 md:py-20">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          <PolicyCard
            icon={<Truck size={24} />}
            title="Frete fixo R$ 20"
            text="Frete fixo de R$ 20,00 para toda a Bahia."
          />
          <PolicyCard
        ...
        <div className="mt-8 rounded-lg border border-neutral-200 bg-neutral-50 p-6 text-sm leading-relaxed text-neutral-600">
          ...
          <p className="mt-1"><strong className="text-neutral-900">Frete:</strong> fixo de R$ 20,00 para toda a Bahia</p>
        </div>
